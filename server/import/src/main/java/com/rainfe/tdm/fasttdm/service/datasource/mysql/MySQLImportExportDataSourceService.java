...
public abstract class MySQLImportExportDataSourceService implements ImportExportDataSourceService {

	private static final Logger logger = Logger.getLogger(MySQLImportExportDataSourceService.class);
